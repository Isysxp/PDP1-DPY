...
ifneq (,$(or $(findstring XXpdp1XX,$(addsuffix XX,$(addprefix XX,$(MAKECMDGOALS)))),$(findstring pdp11,$(MAKECMDGOALS)),$(findstring tx-0,$(MAKECMDGOALS)),\
$(findstring microvax1,$(MAKECMDGOALS)),$(findstring microvax2,$(MAKECMDGOALS)),$(findstring microvax3900,$(MAKECMDGOALS)),\
$(findstring pdp8,$(MAKECMDGOALS)),$(findstring XXvaxXX,$(addsuffix XX,$(addprefix XX,$(MAKECMDGOALS))))))
  VIDEO_USEFUL = true
endif
...
ifeq ($(WIN32),)  #*nix Environments (&& cygwin)
  ...
  ifneq (,$(VIDEO_USEFUL))
    ...
    ifneq (,$(call find_include,SDL2/SDL))
	  ...
	  ifeq (,$(Linux,$(OSTYPE))$(Darwin,$(OSTYPE)))
...
PDP1D = PDP1
ifneq (,$(DISPLAY_OPT))
  PDP1_DISPLAY_OPT = -DDISPLAY_TYPE=DIS_TYPE30 -DPIX_SCALE=RES_FULL -DPIX_SIZE=1
endif
...
PDP8D = PDP8
ifneq (,$(DISPLAY_OPT))
  PDP8_DISPLAY_OPT = -DDISPLAY_TYPE=DIS_VR17 -DPIX_SCALE=RES_FULL -DPIX_SIZE=2
endif
...
PDP8 = ${PDP8D}/pdp8_cpu.c ${PDP8D}/pdp8_clk.c ${PDP8D}/pdp8_df.c \
	...
	${PDP8D}/pdp8_td.c ${PDP8D}/pdp8_ct.c ${PDP8D}/pdp8_fpp.c ${PDP8D}/pdp8_vc8.c ${DISPLAYL}
PDP8_OPT = -I ${PDP8D} $(DISPLAY_OPT) $(PDP8_DISPLAY_OPT) -DPDP8
